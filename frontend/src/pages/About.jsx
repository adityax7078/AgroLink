...
export default function About() {
  return (
    <div className="bg-slate-50/50 dark:bg-slate-950/20 py-16 sm:py-24 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900 dark:text-white sm:text-5xl tracking-tight">
            About Agro<span className="text-emerald-600 dark:text-emerald-400">Link</span>
          </h1>
        ...
        {/* Narrative Section */}
        <div className="mt-16 bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Eliminating the Middleman Dependency</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-slate-100 dark:border-slate-850">
            <div className="flex gap-4">
              <div className="p-3 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-2xl shrink-0 h-12 w-12 flex items-center justify-center">
                <Target className="h-6 w-6" />
              </div>
              <div>
                <h3 className="font-bold text-slate-800 dark:text-slate-100">Target Sellers</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-800 dark:text-slate-100">Target Buyers</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed font-light">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-800 dark:text-slate-100">Fair Price Discovery</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed font-light">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-800 dark:text-slate-100">Unified Contracts</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed font-light">
